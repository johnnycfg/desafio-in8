...
export function Header() {
  ...
  const [newTransactionModalStatus, setNewTransactionModalStatus] = useState(false)
  ...
  return (
    <Box height={212} bgcolor={theme.palette.base[100]} pt="2.5rem">
      <Box display="flex" alignItems="center" justifyContent="space-between" width="100%" maxWidth={1248} margin="0 auto" px="1.5rem">
        ...
        <Button variant="contained" color="primary" onClick={handleOpenNewTransactionModal}>Nova transação</Button>
      </Box>
